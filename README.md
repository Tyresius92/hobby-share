...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly apps create hobby-share-f70d
  fly apps create hobby-share-f70d-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app hobby-share-f70d
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app hobby-share-f70d-staging
  ```

  > **Note:** When creating the staging secret, you may get a warning from the Fly CLI that looks like this:
  >
  > ```
  > WARN app flag 'hobby-share-f70d-staging' does not match app name in config file 'hobby-share-f70d'
  > ```
  >
...
- Create a database for both your staging and production environments. Run the following:
  ...
  ```sh
  fly postgres create --name hobby-share-f70d-db
  fly postgres attach --app hobby-share-f70d hobby-share-f70d-db

  fly postgres create --name hobby-share-f70d-staging-db
  fly postgres attach --app hobby-share-f70d-staging hobby-share-f70d-staging-db
  ```
